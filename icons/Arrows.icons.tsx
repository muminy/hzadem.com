...
export function ArrowUpIcon({ size = 24, color = "currentColor" }: SvgProps) {
  return (
    <svg
...
export function ArrowDownIcon({ size = 24, color = "currentColor" }: SvgProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function ArrowLeftIcon({ size = 24, color = "currentColor" }: SvgProps) {
  return (
    <svg
      width={size}
      height={size}
